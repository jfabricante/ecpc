						...
						<tbody>
							...
							<?php foreach ($entities as $entity): ?>
								<tr>
									...
									<td><?php echo $entity->MODELS; ?></td>
									<td>
										<a href="<?php echo base_url('index.php/vin/group_form/' . $entity->ID); ?>" >
											<i class="fa fa-pencil" aria-hidden="true"></i>
										</a>
									</td>
									<td>
										<a href="<?php echo base_url('index.php/vin/group_notice/' . $entity->ID); ?>" data-toggle="modal" data-target=".bs-example-modal-sm">
