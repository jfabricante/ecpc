		...
		<div class="col-md-5">
			...
			<div class="box box-danger">
				...
				<div class="box-header with-border">
					<a href="<?php echo base_url('index.php/color/form') ?>" data-toggle="modal" data-target=".bs-example-modal-sm">
						<button class="btn btn-flat btn-success pull-right">Add Color <i class="fa fw fa-plus" aria-hidden="true"></i></button>
					</a>
				</div>
